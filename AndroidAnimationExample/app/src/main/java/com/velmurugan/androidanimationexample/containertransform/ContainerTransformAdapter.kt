...
import com.velmurugan.androidanimationexample.databinding.LayoutContainerTransformBinding

class ContainerTransformAdapter : RecyclerView.Adapter<MenuViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MenuViewHolder {
        ...
        val binding = LayoutContainerTransformBinding.inflate(inflater, parent, false)
...
class MenuViewHolder(val adapterPendingOrderBinding: LayoutContainerTransformBinding) :
