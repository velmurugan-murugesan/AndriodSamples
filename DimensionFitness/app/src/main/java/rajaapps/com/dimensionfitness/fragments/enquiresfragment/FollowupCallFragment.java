...
/**
 * Created by velmmuru on 7/27/2017.
 */

public class FollowupCallFragment extends Fragment implements AsyCallback{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        try{
            MyApplication.getEnquiresDaoImpl().getFollowupCallsEnquires(this,getContext());
        }catch (Exception e){
        }
    }
